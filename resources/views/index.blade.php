                    ...
                    <div class="best-sell-slider owl-carousel owl-nav-style">
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                ...
                                <img class="first-img" src="{{ $product->iamge }}" alt="" />
                                    <img class="second-img" src="{{ $product->iamge }}" alt="" />
                                </a>
                            ...
                            <div class="add-to-link">
                                <ul>
                                <li class="cart"><a class="cart-btn" href="{{ route('cart.add' , $product) }}">ADD TO CART </a></li>
                                    <li>
